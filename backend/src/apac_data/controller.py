...
class ApacDataController(ApacDataRepository):
    ...
    def save(self, apac_data):
        created_apac_data = ApacDataModel.objects.create(
            ...
            patient_cns = apac_data.patient_cns,
            patient_cpf = apac_data.patient_cpf,
            ...
            patient_address_postal_code = apac_data.patient_address_postal_code,
